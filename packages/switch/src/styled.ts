...
export const SwitchLabel = styled.label<StyledSwitchProps>`
  ${({ theme, appearance, baseAppearance }) =>
    switchAppearanceTheme(theme, appearance, baseAppearance, 'label')};
  ${({ theme, appearance, baseAppearance, disabled }) =>
    disabled &&
    switchAppearanceTheme(theme, appearance, baseAppearance, [
      'label',
      'disabled',
    ])};
  display: inline-flex;
...
export const SwitchLabelText = styled.span<StyledSwitchProps>`
  ${({ theme, appearance, baseAppearance }) =>
    switchAppearanceTheme(theme, appearance, baseAppearance, ['labelText'])};
...
export const SwitchContainer = styled.span<StyledSwitchProps>`
  ${({ theme, appearance, baseAppearance }) =>
    switchAppearanceTheme(theme, appearance, baseAppearance, 'container')};
...
export const SwitchHandle = styled.span<StyledSwitchProps>`
  ${({ theme, appearance, baseAppearance }) =>
    switchAppearanceTheme(theme, appearance, baseAppearance, 'handle')};
  ${({ theme, appearance, baseAppearance, checked }) =>
    checked &&
    switchAppearanceTheme(theme, appearance, baseAppearance, [
      'handle',
