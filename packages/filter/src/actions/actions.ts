...
export function xcriticalFiltersChangeFilter(
  ...
  return actionCreator(actions.FILTERS_CHANGE_FILTER, name, changes);
}
...
export function xcriticalFiltersRemoveFilter(
  ...
  return actionCreator(actions.FILTERS_REMOVE_FILTER, name, filter);
}
export function xcriticalFiltersApply(
  ...
  return actionCreator(actions.FILTERS_APPLY, name, {
    filters,
    search,
  });
}
...
export function xcriticalFiltersReset(name: string): IFilterAction {
  return actionCreator(actions.FILTERS_RESET, name);
}
export function xcriticalFiltersInit(
  ...
  return actionCreator(actions.FILTERS_INIT, name, {
    filters,
    search,
  });
}
export function xcriticalFiltersAdd(
  ...
  return actionCreator(actions.FILTERS_ADD, name, { filters: $filters });
}
...
export function xcriticalFiltersUpdateSelectedFilters(
  ...
  return actionCreator(actions.FILTERS_UPDATE_SELECTED_FILTERS, name, {
    filters,
  });
}
...
export function xcriticalFiltersSearchUpdate(
  ...
  return actionCreator(actions.FILTERS_SEARCH_UPDATE, name, value);
}
