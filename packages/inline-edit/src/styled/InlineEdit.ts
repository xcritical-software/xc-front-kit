...
export const ReadViewContentWrapper = styled.div<ICommonProps>`
  ...
  :hover {
    ${({ theme, appearance, baseAppearance }) =>
      getInlineEditStatesStyle('hover')(theme, appearance, baseAppearance)}
...
export const EditButton = styled.button<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'editButton', appearance, baseAppearance)}
`;

/* Action Buttons  */
export const ButtonsWrapper = styled.div<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'actionButtonsWrapper', appearance, baseAppearance)}
`;

export const ButtonWrapper = styled.div<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'actionButtonWrapper', appearance, baseAppearance)}
`;

export const Button = styled.button<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'button', appearance, baseAppearance)}
`;

export const ConfirmIcon = styled.svg<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'confirmIcon', appearance, baseAppearance)}
`;
export const CancelIcon = styled.svg<ICommonProps>`
  ${({ theme, appearance, baseAppearance }) =>
    getElementStyles(theme, 'cancelIcon', appearance, baseAppearance)}
`;
