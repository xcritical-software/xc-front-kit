...
export const CheckboxLabel = styled.label<IStyledCheckboxProps>`
  ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, 'checkboxLabel')}
...
export const CheckboxWrapper = styled.div<IStyledCheckboxProps>`
  ...
  border-radius: ${({ theme, appearance, baseAppearance, type }) =>
    type === 'radio'
      ? '50%'
...
export const DefaultCheckbox = styled.div<IStyledCheckboxProps>`
  ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, 'checkbox')}
  background-color: ${({ theme, appearance, baseAppearance, checked }) =>
    checked
      ? checkboxAppearanceTheme(theme, appearance, baseAppearance, [
          'checkbox',
          'backgroundColor',
...
export const Checkbox = styled.div<IStyledCheckboxProps>`
  width: ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, [
      'checkbox',
      'width',
    ])};
  height: ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, [
      'checkbox',
      'height',
    ])};
  color: ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, [
      'checkbox',
      'color',
    ])};
...
export const LabelWrapper = styled.div<IStyledCheckboxProps>`
  ${({ theme, appearance, baseAppearance }) =>
    checkboxAppearanceTheme(theme, appearance, baseAppearance, 'labelWrapper')}
`;
