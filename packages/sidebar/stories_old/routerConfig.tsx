...
const AffiliatesPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
      backgroundColor: 'rgb(30,230,30)',
    }}>
    Affiliates page
  </div>
);
const LandingsPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
...
const StartPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
      backgroundColor: 'rgb(30,130,130)',
    }}>
    Start page
  </div>
);

const ManagersPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
...
const PayoutsPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
      backgroundColor: 'rgb(100,230,30)',
    }}>
    Payouts page
  </div>
);
...
const LeadsPage = (): ReactElement => (
  <div
    style={{
      display: 'flex',
      height: '100vh',
      backgroundColor: 'rgb(130,130,30)',
    }}>
    Leads page
  </div>
);
