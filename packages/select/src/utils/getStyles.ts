...
export const getPaddingStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') =>
    memoizee((elementName) => ({
      paddingLeft: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'paddingLeft',
      ]),
      paddingRight: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'paddingRight',
      ]),
      paddingBottom: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'paddingBottom',
      ]),
      paddingTop: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'paddingTop',
      ]),
    }))
...
export const getMarginStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') =>
    memoizee((elementName) => ({
      marginLeft: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'marginLeft',
      ]),
      marginRight: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'marginRight',
      ]),
      marginBottom: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'marginBottom',
      ]),
      marginTop: selectTheme(theme, appearance, baseAppearance, [
        elementName,
        'marginTop',
      ]),
    }))
...
export const getWidthStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') => {
    ...
    return memoizee((elementName, shouldFitContainer) => {
      const element = selectTheme(
        theme,
        appearance,
        baseAppearance,
...
export const getBorderRadiusStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') => {
    const borderRadius = selectTheme(theme, appearance, baseAppearance, [
      'borderRadius',
    ]);
    ...
    return memoizee((elementName) => {
      ...
      if (isObject(element.borderRadius)) {
        ...
        const topLeft = isBorderRadiusObject
          ? borderRadius.topLeft
          : borderRadius;
        const topRight = isBorderRadiusObject
          ? borderRadius.topRight
          : borderRadius;
        const bottomRight = isBorderRadiusObject
          ? borderRadius.bottomRight
          : borderRadius;
        const bottomLeft = isBorderRadiusObject
        ...
        return {
          ...
          borderTopRightRadius:
            element?.borderRadius?.topRight !== undefined
              ? element.borderRadius.topRight
              : topRight,
          borderBottomRightRadius:
            element?.borderRadius?.bottomRight !== undefined
              ? element.borderRadius.bottomRight
              : bottomRight,
          borderBottomLeftRadius:
            element?.borderRadius?.bottomLeft !== undefined
              ? element.borderRadius.bottomLeft
              : bottomLeft,
        };
      }
...
export const getBackgroundStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') => {
    let background = selectTheme(theme, appearance, baseAppearance, [
      'background',
    ]);
...
export const getCustomStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') =>
    memoizee((elementName, propertyPath) => {
      const propValue = selectTheme(theme, appearance, baseAppearance, [
        elementName,
        propertyPath,
      ]);
...
export const getStatesStyles: GetStyles = memoizee(
  (theme, appearance = 'default', baseAppearance = 'default') => {
    const hoverStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'hover'
    );
    const activeStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'active'
    );
    const focusStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'focus'
    );
    const selectedStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'selected'
    );
    const disabledStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'disabled'
    );
    const filledStyles = getAppearanceStyleProperty(
      theme,
      appearance,
      baseAppearance,
      'filled'
