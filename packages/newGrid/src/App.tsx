...
const App = ({ items, columns, width, height, isDisableSelect = false, isMultiSelect = false, onChangeColumns = () => { }, totals }: any) => {
  ...
  const cell = ({ columnIndex, key, parent, rowIndex, style }: any) => {
